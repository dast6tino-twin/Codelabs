...
import ru.dast_6_tino.adaptiveapps.data.Account
...
object LocalAccountsDataProvider {
     ...
     */
    fun getContactAccountByUid(
        accountId: Long,
    ): Account = allUserContactAccounts.firstOrNull { it.id == accountId } ?: allUserContactAccounts.first()
