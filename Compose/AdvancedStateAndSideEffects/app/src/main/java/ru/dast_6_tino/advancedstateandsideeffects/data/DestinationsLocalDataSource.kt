...
class DestinationsLocalDataSource @Inject constructor() {
    ...
    private companion object {
        ...
        const val DEFAULT_IMAGE_WIDTH = "250"
    ...
    val craneRestaurants = listOf(
        ExploreModel(
            ...
            imageUrl = "https://images.unsplash.com/photo-1534308983496-4fabb1a015ee" +
                "?ixlib=rb-1.2.1&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = DALLAS,
            description = "2241 Restaurants",
            imageUrl = "https://images.unsplash.com/photo-1495749388945-9d6e4e5b67b1" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = CORDOBA,
            description = "876 Restaurants",
            imageUrl = "https://images.unsplash.com/photo-1562625964-ffe9b2f617fc" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=250&q=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = MADRID,
        ...
        ExploreModel(
            city = MALDIVAS,
            description = "1286 Restaurants",
            imageUrl = "https://images.unsplash.com/flagged/photo-1556202256-af2687079e51" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = ASPEN,
            description = "2241 Restaurants",
            imageUrl = "https://images.unsplash.com/photo-1542384557-0824d90731ee" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = BALI,
    ...
    val craneHotels = listOf(
        ...
        ExploreModel(
            ...
            imageUrl = "https://images.unsplash.com/photo-1561409037-c7be81613c1f" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = NAPLES,
        ...
        ExploreModel(
            city = DALLAS,
            description = "2241 Available Properties",
            imageUrl = "https://images.unsplash.com/46/sh3y2u5PSaKq8c4LxB3B_submission-photo-4.jpg" +
                "?ixlib=rb-1.2.1&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = CORDOBA,
            description = "876 Available Properties",
            imageUrl = "https://images.unsplash.com/photo-1570214476695-19bd467e6f7a" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
    )
    ...
    val craneDestinations = listOf(
        ...
        ExploreModel(
            city = GRANADA,
            description = "Nonstop - 2h 12m+",
            imageUrl = "https://images.unsplash.com/photo-1534423839368-1796a4dd1845" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = MALDIVAS,
            description = "Nonstop - 9h 24m+",
            imageUrl = "https://images.unsplash.com/photo-1544550581-5f7ceaf7f992" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = WASHINGTONDC,
            description = "Nonstop - 7h 30m+",
            imageUrl = "https://images.unsplash.com/photo-1557160854-e1e89fdd3286" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = BARCELONA,
        ...
        ExploreModel(
            ...
            imageUrl = "https://images.unsplash.com/photo-1486575008575-27670acb58db" +
                "?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = NAPLES,
        ...
        ExploreModel(
            ...
            imageUrl = "https://images.unsplash.com/photo-1505761671935-60b3a7427bad" +
                ...
                "&auto=format&fit=crop&w=$DEFAULT_IMAGE_WIDTH",
        ),
        ExploreModel(
            city = PARIS,
            description = "Nonstop - 2h 25m+",
            imageUrl = "https://images.unsplash.com/photo-1509299349698-dd22323b5963" +
