...
import ru.dast_6_tino.advancedstateandsideeffects.data.MADRID
...
class DetailsActivityTest {
    ...
    private fun waitForMap(onCameraPosition: (CameraPosition) -> Unit) {
        ...
        composeTestRule.activityRule.scenario.onActivity { action ->
            action.findViewById<MapView>(R.id.map).getMapAsync { map ->
